...
class PaywallFourInteractionHelper {
    private weak var viewController: PaywallFourViewController?
    private let viewModel: PaywallFourViewModel

    init(viewController: PaywallFourViewController, viewModel: PaywallFourViewModel) {
