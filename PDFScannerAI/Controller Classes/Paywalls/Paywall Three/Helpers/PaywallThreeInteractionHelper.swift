...
class PaywallThreeInteractionHelper {
    private weak var viewController: PaywallThreeViewController?
    private let viewModel: PaywallThreeViewModel

    init(viewController: PaywallThreeViewController, viewModel: PaywallThreeViewModel) {
